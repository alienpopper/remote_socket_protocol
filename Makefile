...
all: generate-messages $(TARGET) $(RSP_RM_TARGET) $(RSP_ES_TARGET) $(RSP_BSD_SOCKETS_TOP_TARGET) $(RSPCLIENT_STATIC_TARGET) $(RSPCLIENT_SHARED_TARGET) $(RSPFULLCLIENT_STATIC_TARGET) $(RESOURCE_SERVICE_TARGET) $(BSD_SOCKETS_TARGET) $(NAME_SERVICE_TARGET) $(ENDORSEMENT_SERVICE_TARGET) $(RSP_ENDORSEMENT_TOOL_TARGET) $(RSP_CLI_TOOL_TARGET) $(RSP_SSHD_TARGET) $(RSP_SSH_TARGET)
