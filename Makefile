...
LOGGING_TEST_TARGET := $(BIN_DIR)/logging_test
...
BSD_SOCKETS_LOGGING_GENERATED_SOURCE := $(PROTOBUF_GENERATED_DIR)/resource_service/bsd_sockets/bsd_sockets_logging.pb.cc
BSD_SOCKETS_LOGGING_GENERATED_HEADER := $(PROTOBUF_GENERATED_DIR)/resource_service/bsd_sockets/bsd_sockets_logging.pb.h
BSD_SOCKETS_LOGGING_GENERATED_OBJECT := $(OBJ_DIR)/build/gen/resource_service/bsd_sockets/bsd_sockets_logging.pb.o
...
HTTPD_GENERATED_SOURCE := $(PROTOBUF_GENERATED_DIR)/resource_service/httpd/httpd.pb.cc
HTTPD_GENERATED_HEADER := $(PROTOBUF_GENERATED_DIR)/resource_service/httpd/httpd.pb.h
HTTPD_GENERATED_OBJECT := $(OBJ_DIR)/build/gen/resource_service/httpd/httpd.pb.o
...
PROTOBUF_ALL_GENERATED_SOURCE := $(PROTOBUF_GENERATED_SOURCE) $(BSD_SOCKETS_GENERATED_SOURCE) $(BSD_SOCKETS_LOGGING_GENERATED_SOURCE) $(SSHD_GENERATED_SOURCE) $(HTTPD_GENERATED_SOURCE) $(ENDORSEMENT_GENERATED_SOURCE) $(NAME_SERVICE_GENERATED_SOURCE) $(LOGGING_GENERATED_SOURCE)
PROTOBUF_GENERATED_OBJECT := $(OBJ_DIR)/build/gen/messages.pb.o $(BSD_SOCKETS_GENERATED_OBJECT) $(BSD_SOCKETS_LOGGING_GENERATED_OBJECT) $(SSHD_GENERATED_OBJECT) $(HTTPD_GENERATED_OBJECT) $(ENDORSEMENT_GENERATED_OBJECT) $(NAME_SERVICE_GENERATED_OBJECT) $(LOGGING_GENERATED_OBJECT)
...
BSD_SOCKETS_LOGGING_DESC := $(PROTOBUF_GENERATED_DIR)/resource_service/bsd_sockets/bsd_sockets_logging.desc
BSD_SOCKETS_LOGGING_DESC_HEADER := $(PROTOBUF_GENERATED_DIR)/resource_service/bsd_sockets/bsd_sockets_logging_desc.hpp
...
HTTPD_DESC := $(PROTOBUF_GENERATED_DIR)/resource_service/httpd/httpd.desc
...
TOP_BIN_DIR := bin
RSP_RM_TARGET := $(TOP_BIN_DIR)/rsp_rm
RSP_ES_TARGET := $(TOP_BIN_DIR)/rsp_es
RSP_NS_TARGET := $(TOP_BIN_DIR)/rsp_ns
RSP_BSD_SOCKETS_TOP_TARGET := $(TOP_BIN_DIR)/rsp_bsd_sockets
...
ENDORSEMENT_SERVICE_SOURCES := \
	$(COMMON_ENDORSEMENT_SOURCE) \
	$(FULL_CLIENT_LIBRARY_SOURCES) \
	resource_service/endorsement/resource_service_endorsement.cpp \
	resource_service/endorsement/resource_service_endorsement_main.cpp
...
HTTPD_RESOURCE_SERVICE_TEST_OBJECTS := \
	...
	$(OBJ_DIR)/test/httpd_resource_service_test.o
...
ENDORSEMENT_SERVICE_TEST_OBJECTS := \
	...
	$(OBJ_DIR)/client/cpp/rsp_client.o \
	$(OBJ_DIR)/client/cpp_full/rsp_client.o \
	$(OBJ_DIR)/resource_service/endorsement/resource_service_endorsement.o \
...
all: generate-messages $(TARGET) $(RSP_RM_TARGET) $(RSP_ES_TARGET) $(RSP_NS_TARGET) $(RSP_BSD_SOCKETS_TOP_TARGET) $(RSPCLIENT_STATIC_TARGET) $(RSPCLIENT_SHARED_TARGET) $(RSPFULLCLIENT_STATIC_TARGET) $(RESOURCE_SERVICE_TARGET) $(BSD_SOCKETS_TARGET) $(NAME_SERVICE_TARGET) $(ENDORSEMENT_SERVICE_TARGET) $(RSP_ENDORSEMENT_TOOL_TARGET) $(RSP_CLI_TOOL_TARGET) $(RSP_SSHD_TARGET) $(RSP_SSH_TARGET)
...
$(RSP_RM_TARGET): $(TARGET)
	@mkdir -p $(TOP_BIN_DIR)
	cp $(TARGET) $(RSP_RM_TARGET)

$(RSP_BSD_SOCKETS_TOP_TARGET): $(BSD_SOCKETS_TARGET)
	@mkdir -p $(TOP_BIN_DIR)
	cp $(BSD_SOCKETS_TARGET) $(RSP_BSD_SOCKETS_TOP_TARGET)
...
$(RSPCLIENT_SHARED_TARGET): directories $(BORINGSSL_CRYPTO_LIB) $(PROTOBUF_LITE_LIB) $(PROTOBUF_ALL_GENERATED_SOURCE)
	@mkdir -p $(LIB_DIR)
	$(CXX) $(SHARED_CXXFLAGS) $(CPPFLAGS) -DRSPCLIENT_BUILD_DLL -shared $(CLIENT_LIBRARY_SOURCES) $(PROTOBUF_ALL_GENERATED_SOURCE) $(OS_COMMON_SOURCE) $(OS_SOCKET_SOURCE) $(OS_SOURCE) $(BORINGSSL_CRYPTO_LIB) $(PROTOBUF_LITE_LIB) $(OS_SYSTEM_LIBS) $(LDFLAGS) -o $@
...
$(RSP_ES_TARGET): $(ENDORSEMENT_SERVICE_TARGET)
	@mkdir -p $(TOP_BIN_DIR)
	cp $(ENDORSEMENT_SERVICE_TARGET) $(RSP_ES_TARGET)

$(RSP_NS_TARGET): $(NAME_SERVICE_TARGET)
	@mkdir -p $(TOP_BIN_DIR)
	cp $(NAME_SERVICE_TARGET) $(RSP_NS_TARGET)
...
$(LOGGING_TEST_TARGET): directories $(BORINGSSL_CRYPTO_LIB) $(PROTOBUF_LITE_LIB) $(LOGGING_TEST_OBJECTS)
	$(CXX) $(CXXFLAGS) $(LOGGING_TEST_OBJECTS) $(BORINGSSL_CRYPTO_LIB) $(PROTOBUF_LITE_LIB) $(OS_SYSTEM_LIBS) $(LDFLAGS) -o $@
...
$(HTTPD_RESOURCE_SERVICE_TEST_TARGET): directories $(BORINGSSL_CRYPTO_LIB) $(PROTOBUF_LITE_LIB) $(HTTPD_RESOURCE_SERVICE_TEST_OBJECTS)
	$(CXX) $(CXXFLAGS) $(HTTPD_RESOURCE_SERVICE_TEST_OBJECTS) $(BORINGSSL_CRYPTO_LIB) $(PROTOBUF_LITE_LIB) $(OS_SYSTEM_LIBS) $(LDFLAGS) -o $@
...
RSP_HTTPD_OBJECTS := \
	...
	$(OBJ_DIR)/resource_service/bsd_sockets/resource_service_bsd_sockets.o \
	$(OBJ_DIR)/resource_service/httpd/resource_service_httpd.o \
	$(OBJ_DIR)/resource_service/httpd/resource_service_httpd_main.o

$(RSP_HTTPD_TARGET): directories $(BORINGSSL_CRYPTO_LIB) $(PROTOBUF_LITE_LIB) $(RSP_HTTPD_OBJECTS)
	$(CXX) $(CXXFLAGS) $(RSP_HTTPD_OBJECTS) $(BORINGSSL_CRYPTO_LIB) $(PROTOBUF_LITE_LIB) $(OS_SYSTEM_LIBS) $(LDFLAGS) -o $@

rsp-httpd: $(RSP_HTTPD_TARGET)
...
test-logging: $(LOGGING_TEST_TARGET)
	$(LOGGING_TEST_TARGET)
...
test-httpd-resource-service: $(HTTPD_RESOURCE_SERVICE_TEST_TARGET)
	$(HTTPD_RESOURCE_SERVICE_TEST_TARGET)
...
$(PROTOBUF_GENERATED_SOURCE): messages.proto resource_service/bsd_sockets/bsd_sockets.proto resource_service/bsd_sockets/bsd_sockets_logging.proto resource_service/sshd/sshd.proto resource_service/httpd/httpd.proto resource_service/endorsement/endorsement.proto resource_service/name/name.proto logging/logging.proto $(PROTOBUF_PROTOC)
	...
	$(PROTOBUF_PROTOC) --proto_path=$(PROJECT_ROOT) --proto_path=$(PROTOBUF_INCLUDE_DIR) --descriptor_set_out=$(BSD_SOCKETS_LOGGING_DESC) --include_imports resource_service/bsd_sockets/bsd_sockets_logging.proto
	...
	@mkdir -p $(dir $(HTTPD_DESC))
	$(PROTOBUF_PROTOC) --proto_path=$(PROJECT_ROOT) --proto_path=$(PROTOBUF_INCLUDE_DIR) --descriptor_set_out=$(HTTPD_DESC) --include_imports resource_service/httpd/httpd.proto
	...
	python3 $(EMBED_DESCRIPTOR_SCRIPT) $(BSD_SOCKETS_LOGGING_DESC) $(BSD_SOCKETS_LOGGING_DESC_HEADER) --name kBsdSocketsLoggingDescriptor
	...
	python3 $(EMBED_DESCRIPTOR_SCRIPT) $(ENDORSEMENT_DESC) $(ENDORSEMENT_DESC_HEADER) --name kEndorsementDescriptor
...
$(BSD_SOCKETS_LOGGING_GENERATED_SOURCE): $(PROTOBUF_GENERATED_SOURCE)

$(BSD_SOCKETS_LOGGING_GENERATED_HEADER): $(BSD_SOCKETS_LOGGING_GENERATED_SOURCE)

$(BSD_SOCKETS_DESC): $(PROTOBUF_GENERATED_SOURCE)

$(BSD_SOCKETS_DESC_HEADER): $(BSD_SOCKETS_DESC)

$(BSD_SOCKETS_LOGGING_DESC): $(PROTOBUF_GENERATED_SOURCE)

$(BSD_SOCKETS_LOGGING_DESC_HEADER): $(BSD_SOCKETS_LOGGING_DESC)
...
$(HTTPD_GENERATED_SOURCE): $(PROTOBUF_GENERATED_SOURCE)

$(HTTPD_GENERATED_HEADER): $(HTTPD_GENERATED_SOURCE)

$(HTTPD_DESC): $(PROTOBUF_GENERATED_SOURCE)

$(HTTPD_DESC_HEADER): $(HTTPD_DESC)
...
$(BSD_SOCKETS_LOGGING_GENERATED_OBJECT): $(BSD_SOCKETS_LOGGING_GENERATED_SOURCE) $(BSD_SOCKETS_LOGGING_GENERATED_HEADER)
	@mkdir -p $(dir $@)
	$(CXX) $(CPPFLAGS) $(CXXFLAGS) -c $(BSD_SOCKETS_LOGGING_GENERATED_SOURCE) -o $@

$(SSHD_GENERATED_OBJECT): $(SSHD_GENERATED_SOURCE) $(SSHD_GENERATED_HEADER)
	@mkdir -p $(dir $@)
	$(CXX) $(CPPFLAGS) $(CXXFLAGS) -c $(SSHD_GENERATED_SOURCE) -o $@

$(HTTPD_GENERATED_OBJECT): $(HTTPD_GENERATED_SOURCE) $(HTTPD_GENERATED_HEADER)
	@mkdir -p $(dir $@)
	$(CXX) $(CPPFLAGS) $(CXXFLAGS) -c $(HTTPD_GENERATED_SOURCE) -o $@

$(ENDORSEMENT_GENERATED_SOURCE): $(PROTOBUF_GENERATED_SOURCE)

$(ENDORSEMENT_GENERATED_HEADER): $(ENDORSEMENT_GENERATED_SOURCE)

$(ENDORSEMENT_DESC): $(PROTOBUF_GENERATED_SOURCE)

$(ENDORSEMENT_DESC_HEADER): $(ENDORSEMENT_DESC)

$(ENDORSEMENT_GENERATED_OBJECT): $(ENDORSEMENT_GENERATED_SOURCE) $(ENDORSEMENT_GENERATED_HEADER)
	@mkdir -p $(dir $@)
	$(CXX) $(CPPFLAGS) $(CXXFLAGS) -c $(ENDORSEMENT_GENERATED_SOURCE) -o $@
...
$(LOGGING_GENERATED_SOURCE): $(PROTOBUF_GENERATED_SOURCE)

$(LOGGING_GENERATED_HEADER): $(LOGGING_GENERATED_SOURCE)

$(LOGGING_DESC): $(PROTOBUF_GENERATED_SOURCE)

$(LOGGING_DESC_HEADER): $(LOGGING_DESC)
...
$(LOGGING_GENERATED_OBJECT): $(LOGGING_GENERATED_SOURCE) $(LOGGING_GENERATED_HEADER)
	@mkdir -p $(dir $@)
