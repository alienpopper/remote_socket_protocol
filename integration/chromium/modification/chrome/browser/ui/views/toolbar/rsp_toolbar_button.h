...
class RspConfigBubble : public views::BubbleDialogDelegateView {
 public:
  ...
  static bool IsShowing() { return !!current_bubble_; }
 ...
 private:
  ...
  // Tracks the currently-showing bubble to prevent double-open.
  // Cleared in ~RspConfigBubble().
  static RspConfigBubble* current_bubble_;
